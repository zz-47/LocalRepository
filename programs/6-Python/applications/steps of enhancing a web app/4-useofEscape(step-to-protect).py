...
def humble_world(name):
    return f'<h1>{escape(name)}</h1><br></br><p>Hey buddy I\'m a web app designed for educational purposes.</p><br></br><p>Other Information is provided as : </p><ul><li>This page demostrates the author , how flask webapps work.</li><li>This webapp is made using python , HTML and Flask micro framework.</li><li>This is a demostration that python can combine front end and backend using flask.</li></ul>'
